      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white shadow-xl">
          <div className="flex h-16 shrink-0 items-center justify-between px-4 border-b border-gray-200">
            <h1 className="text-xl font-bold text-primary-600">EXTRANEF</h1>
            <button
              type="button"
          ...
          <div className="border-t border-gray-200 p-4">
            <button
              ...
              className="flex w-full items-center px-3 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-md"
            >
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6 ml-auto">
              ...
              <div className="flex items-center gap-x-1">
                ...
                <span className="hidden lg:block text-sm font-medium text-gray-900 ml-2">
                  {user?.nome}
                </span>
              </div>
            </div>
